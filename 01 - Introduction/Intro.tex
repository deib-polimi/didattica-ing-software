...
The binding to an object is optional — if a name is not bound to an object, the name is said to be null"\cite{}.
\end{itemize}
...
public class Client {
	...
	public static void main(String[] args)
    {
        Bike bike1; // defines a new identifier (pointer) of class Bike with a predefined value null
