...
\begin{itemize}
\item se in una classe non viene definito un costruttore ne viene automaticamente generato ed utilizzato uno di default senza argomenti che, all'atto della creazione doll'oggetto, richiama il costruttore di default senza argomenti della super classe.
