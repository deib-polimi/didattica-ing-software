...
\subsection{Costruttori}
\subsubsection{Esercizio}
\Esercizio{Modificare la classe bicibletta affinch\`e sia possibile creare una bicicletta con un numero di marce  un dato ritmo di pedalata}
...
\subsubsection{Esercizio}
\Esercizio{Modificare la classe bicibletta affinch\`e sia possibile creare una bicicletta con un dato numero di marce}
