...
\end{itemize}
\end{itemize}
\lstinputlisting{Source/Esercizio1.java}
\begin{itemize}
...
\item \textbf{Creare un file Java}
\begin{itemize}
\item crea un file Java con nome \texttt{Esercizio2}
\item scrivere il seguente codice Java
\end{itemize}
\end{itemize}

\lstinputlisting{Source/Esercizio2.java}
\begin{itemize}
\item \textbf{Descrizione del file creato}
\begin{itemize}
...
\lstinputlisting{Source/Bike.java}
...
\lstinputlisting{Source/Client2.java}
...
\lstinputlisting{Source/Bike2.java}
...
\end{itemize}
\lstinputlisting{Source/transport/Bike2.java}

\subsection{Esercizio}
\Esercizio{Modificare il client affinche' chiami il metodo \texttt{printState()}}

\lstinputlisting{Source/Client3.java}
