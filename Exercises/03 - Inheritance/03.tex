...
\newcommand{\hmwkTitle}{03 - Ereditariet\`a e Interfacce} % Assignment title
...
\Esercizio{Si implmenti il gioco degli scacchi
\begin{itemize}
...
Il primo passo da eseguire \`e analizzare il problema ed identificare le entit\`a (ovvero delle classi candidate). In questo caso, abbiamo \texttt{Scacchiera}, \texttt{Casella}, \texttt{Pezzo}, \ldots

\textbf{Colori}

Iniziamo ad analizzare un sottoproblema: modelliamo il colore delle pedine.

\Esercizio{Le pedine possono avere $2$ colori: \emph{nero} e \emph{bianco}}
...
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/Color.java}

\subsubsection{Casella}

Un nuovo sottoproblema: modelliamo la casella.

\Esercizio{Analizziamo le caratteristiche di una casella:
...
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/Coordinata.java}
...
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/Casella.java}

\subsubsection{Pezzi}
\Esercizio{I pezzi possono essere: Torre, Cavallo, Alfiere, Regina, Re, ognuno con differenti capacit\`a di movimento (si assuma che il Pedone possa effettuare solo movimenti di una casella).}
...
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/pezzi/Pezzo.java}
...
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/pezzi/Re.java}


\textbf{Alfiere}
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/pezzi/Alfiere.java}



\textbf{Torre}
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/pezzi/Torre.java}



\textbf{Cavallo}
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/pezzi/Cavallo.java}


\textbf{Donna}
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/pezzi/Donna.java}


\textbf{Pedone}
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/pezzi/Pedone.java}


\subsubsection{Scacchiera}
\Esercizio{Una scacchiera contiene dei pezzi, quando viene creata i pezzi sono posti sulla scacchiera in maniera corretta.}
\lstinputlisting{Source/Scacchi/src/scacchi/scacchiera/Scacchiera.java}


\subsubsection{Player}
\Esercizio{Nel gioco degli scacchi ci sono due giocatori a ciascuno dei quali \`e associato un colore}

\lstinputlisting{Source/Scacchi/src/scacchi/Player.java}
\subsubsection{Gioco}
\begin{framed}
\textbf{Esercizio 1.6} Il gioco consiste in una serie di mosse iterativamente effettuate dai due giocatori
\end{framed}
\lstinputlisting{Source/Scacchi/src/scacchi/Gioco.java}


\subsubsection{Main}
\lstinputlisting{Source/Scacchi/src/scacchi/Main.java}

\subsection{Persone e Studenti}
\Esercizio{Implementare le classi per rappresentare delle persone e degli studenti.
\begin{itemize}
...
\Esercizio{Implementare una gerarchia di classe che rappresenti delle forme geometriche, permettendo di calcolare
\begin{itemize}
\item  La loro area
\item Perimetro
...
\Esercizio{Deve essere possibile ruotare e ridimensionare gli oggetti shape. A seconda della loro natura (e.g., un cerchio non pu\`o essere ruotato ma pu\`o essere ridimensionato)}
