...
\item copia l'archivio nella cartella di installazione	\texttt{sudo cp -r jdk-8u74-linux-x64.tar.gz /usr/local/java}
...
\begin{itemize}
\item \texttt{sudo update-alternatives --install "/usr/bin/java" "java" "/usr/local/java/jdk1.8.0\_74/bin/java" 1}
\item \texttt{sudo update-alternatives --install "/usr/bin/javaws" "javaws" "/usr/local/java/jdk1.8.0\_74/bin/javaws" 1}
