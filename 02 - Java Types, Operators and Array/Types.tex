...
\subsection{Esercizio 6: ComplexSet}
\begin{framed}
\textbf{Esercizio 6}:  Modificare il codice del secondo esercizio affinch\`e mantenga un insieme
...
\subsection{Eserzizio 7: Riepilogo - Negozio}
\subsubsection{Esercizio 7a: CD-Final-Immutabile}
\begin{framed}
\textbf{Esercizio 1}: Progettare e implementare una classe che rappresenti un CD. Ogni CD ha un \emph{unico} numero di serie. Un numero di serie (o numero seriale) è un numero identificativo assegnato in maniera univoca per distinguere un esemplare di una serie. Un cd ha un titolo, un autore e un prezzo.
\end{framed}
...
\item \texttt{foat getPrezzo()}: ritorna il prezzo del CD
...
\subsubsection{Esercizio 7b: Enum: tipo del CD}
\begin{framed}
\textbf{Esercizio 7b}: Un ha un tipo. Il tipo del cd pu\`o essere pop, country oppure dance.
\end{framed}
...
\subsubsection{Esercizio 7c: Riuso del costruttore: scaffale di dimensione definita nel costruttore}
\begin{framed}
\textbf{Esercizio  7c}: Modificare la classe \texttt{Shelf} per consentire la \emph{creazione} di uno scaffale con una dimensione passata come parametro al costruttore ma minore della dimensione massima fissata
\end{framed}
...
\subsubsection{Esercizio 7d: Cliente}
\begin{framed}
\textbf{Esercizio 7d}: Un cliente ha un nome,  e un codice fiscale
\end{framed}
\begin{lstlisting}[language=Java,escapechar=|]
package esercitazione2;
...
\subsubsection{Esercizio 7e: Negozio}
\begin{framed}
\textbf{Esercizio  7e}: Il negozio vuole tenere traccia dei CD venduti, per ogni CD vuole tenere traccia dell'acquirente
\end{framed}
\begin{lstlisting}[language=Java,escapechar=|]
package esercitazione2;
...
\subsubsection{Esercizio 7f: Implementare un client per il negozio}
\begin{framed}
\textbf{Esercizio 7f}: Il negozio vuole tenere traccia dei CD venduti, per ogni CD vuole tenere traccia dell'acquirente
\end{framed}
\begin{lstlisting}[language=Java,escapechar=|]
package esercitazione2;
...
\subsection{Esercizio 8: Riepilogo - Morra Cinese}
\begin{framed}
\textbf{Esercizio 8}: Implementare il gioco della morra cinese (carta, forbice, sasso).
...
\end{itemize}
\item Esercizio 2: Modificare il gioco della Mora cinese come seguer:
\begin{itemize}
...
\end{itemize}
\item Esercizio 4: modificare la soluzione dell'esercizio n come segue:
\begin{itemize}
