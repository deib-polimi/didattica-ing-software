...
comunicazione con RMI e Socket e il Command Line Interface (CLI).
...
persone.
\textit{Gli studenti di telecomunicazioni, possono fare i gruppi di un massimo
di 4 persone ed i requisiti applicati corrisponderanno il gruppo con
una persona in meno, con l'eccezione di un gruppo di 1 persona.}\\
