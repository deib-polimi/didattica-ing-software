...
\item now you can browse your sonar installation at \url{http://localhost:9000/}
\item modify your pom.xml (pom.xml) to have the following line under
  the properties tag:\\
...
You will notice that the statistics that you option from the previous
sonar analysis does not contain unit test coverage information. To
enable Sonar calculating test coverage:
...
\end{lstlisting}
\item not re-run the \texttt{maven sonar} run configuration and go to
